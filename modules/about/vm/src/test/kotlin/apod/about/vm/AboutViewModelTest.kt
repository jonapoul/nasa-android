...
import apod.about.data.GithubReleaseModel
...
class AboutViewModelTest {
  ...
  fun `Open issues page`() = runTest {
    ...
    // Then
    verify(exactly = 1) { urlOpener.openUrl("https://github.com/jonapoul/apod-android/issues/new") }
  ...
  fun `Open repo page`() = runTest {
    ...
    // Then
    verify(exactly = 1) { urlOpener.openUrl("https://github.com/jonapoul/apod-android") }
    confirmVerified(urlOpener)
  }
}
